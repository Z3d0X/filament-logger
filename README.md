...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/filament-logger.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/filament-logger)
...
```bash
php artisan vendor:publish --tag="filament-logger-views"
```

## Usage

```php
$filamentLogger = new Z3d0X\FilamentLogger();
echo $filamentLogger->echoPhrase('Hello, Z3d0X!');
```
